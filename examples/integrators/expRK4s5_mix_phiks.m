...
% Method: exponential Runge Kutta of order 4
  ...
  for j = 1:ts
    ...
    [aux1_1,aux1half_1,s1_1,q1_1] = phiks(tau,A{1},FtU_1,1,tol*normU_1,2);
    [aux1_2,aux1half_2,s1_2,q1_2] = phiks(tau,A{2},FtU_2,1,tol*normU_2,2);
    c1_1 = q1_1 + s1_1*1 + 2;
    c1_2 = q1_2 + s1_2*1 + 2;
    ...
    [aux2_1,aux2half_1,s2_1,q2_1] = phiks(tau,A{1},D2_1,2,tol*normU_1,2);
    [aux2_2,aux2half_2,s2_2,q2_2] = phiks(tau,A{2},D2_2,2,tol*normU_2,2);
    c2_1 = q2_1 + s2_1*2 + 2;
    c2_2 = q2_2 + s2_2*2 + 2;
    s2 = (s2_1+s2_2)/2;
    q2 = (q2_1+q2_2)/2;
    ...
    [aux3_1,aux3half_1,s3_1,q3_1] = phiks(tau,A{1},D3_1,2,tol*normU_1,2);
    [aux3_2,aux3half_2,s3_2,q3_2] = phiks(tau,A{2},D3_2,2,tol*normU_2,2);
    c3_1 = q3_1 + s3_1*2 + 2;
    c3_2 = q3_2 + s3_2*2 + 2;
    s3 = (s3_1+s3_2)/2;
    q3 = (q3_1+q3_2)/2;
    ...
    [aux4_1,aux4half_1,s4_1,q4_1] = phiks(tau,A{1},...
                                         {0,0,-1/4*D4_1,-D2_1-D3_1+D4_1},...
                                         3,tol*normU_1,2);
    [aux4_2,aux4half_2,s4_2,q4_2] = phiks(tau,A{2},...
                                         {0,0,-1/4*D4_2,-D2_2-D3_2+D4_2},...
                                         3,tol*normU_2,2);
    c4_1 = q4_1*3 + s4_1*3 + 2;
    c4_2 = q4_2*3 + s4_2*3 + 2;
    s4 = (s4_1+s4_2)/2;
    q4 = (q4_1+q4_2)/2;
    c4 = c4_1+c4_2;
    ...
    [aux5_1,s5_1,q5_1] = phiks(tau,A{1},...
                                    {0,0,-D4_1+4*D5_1,4*D4_1-8*D5_1},...
                                    3,tol*normU_1,1);
    [aux5_2,s5_2,q5_2] = phiks(tau,A{2},...
                                    {0,0,-D4_2+4*D5_2,4*D4_2-8*D5_2},...
                                    3,tol*normU_2,1);
    c5_1 = q5_1*3 + s5_1*3 + 1;
    c5_2 = q5_2*3 + s5_2*3 + 1;
    s5 = (s5_1+s5_2)/2;
    q5 = (q5_1+q5_2)/2;
    c5 = c5_1+c5_2;
