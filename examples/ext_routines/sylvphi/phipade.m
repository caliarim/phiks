...
% PHIPADE - Evaluate phi functions using diagonal Pade approximations.
%
% SYNOPSIS:
%    phi_k                     = phipade(z, k);
%    phi_k                     = phipade(z, k, d); 
...
%   integrators using diagonal Pade approximants.
...
%   d - Degree of diagonal Pade approximant.  OPTIONAL.
%       Default value: d = 7.
%
% RETURNS:
%    phi_k                     =      \phi_k(z)
...
PADE_DEGR = 7;          % degree of (d,d)-Pade approximant
...
[s, z] = scaled_arg(z);
Id = speye(size(z));
[phi_vals{1:k}] = scaled_pade(z, Id, d, k);     % (d,d)-Pade approx
...
% Scaling to obtain well-behaved Pade approximations.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Internal eval functions implementing Pade algorithm.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Pade eval algorithm due to Higham in
...
% Re-normalised (d,d)-Pade coefficients for the \phi_\ell functions.
%
%%%% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%
% This code is based on the explicit (d,d)-Pade formulae derived by W.
